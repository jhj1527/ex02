<script setup>
  ...
  const getItem = () => {
    input.name = props.dto.name || "";
    input.price = props.dto.price || 0;
    input.discount = props.dto.discount || 0;
    input.category = props.dto.category || "";
    input.content = props.dto.content || "";
    
    props.dto.attachList.forEach((item, i) => {
